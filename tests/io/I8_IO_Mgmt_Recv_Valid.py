    ...
    def run(self, driver, log) -> TestResult:
        ...
        if handle_before is None:
            return TestResult(
                ...
                f"Available ruhids: {[r['ruhid'] for r in ruhs_before]}"
            )

        cap_before = int(handle_before.get("ruamw", 0))
...
"""
        ...
        cap_after = int(handle_after.get("ruamw", 0))
