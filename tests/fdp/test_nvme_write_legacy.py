...
class TestNVMeWriteLegacy(BaseTest):
    ...
    def run(self, driver, log) -> TestResult:
        ...
        capacity_before = int(handle0.get("ruamw", handle0.get("RUAMWSectors", handle0.get("ruamw_sectors", 0))))
        ...
        capacity_after = int(handle0_after.get("ruamw", handle0_after.get("RUAMWSectors", 0)))
